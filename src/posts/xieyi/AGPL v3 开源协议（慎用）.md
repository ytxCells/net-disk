...
原文出自：
- 链接：[https://pdai.tech/md/dev-spec/opensource/dev-opensource.html]
- 作者：[pdai]
- 使用许可：遵循 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) 协议，非商业性使用并注明原作者，改编需同享此协议。

提示：转引或改编本文请遵照 CC BY-NC-SA 4.0 协议，商业用途需获得原作者授权。
